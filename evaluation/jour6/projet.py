...
def identifiant(cour, date, numero):
    ...
    numero = numero.replace("quinze", "15")
    numero = numero.strip()
...
operands = [
    ...
    Args("CA paris\n","17 janvier 2018","n° quinze/17249"),
    Args("CA Paris","18 janvier 2018","n° 15/13129"),
    Args("CA Pris","19 janvier 2018\n","n° 15/10939 "),
    ...
    Args("CA Paris\n","7 février 2018	","n° 12/07788"),
    Args("CA Pris","\n7 février 2018	","n° quinze/05318"),
    ...
    Args("CA Paris","21 février 2018","n° quinze/06721"),
